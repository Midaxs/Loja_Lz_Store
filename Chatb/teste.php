...
<head>
    ...
    <style>
        ...
        .autor { font-size: 10px; color: Black; }
        .mensagem-cliente { align-self: flex-end; background-color: red; color: white; padding: 10px 14px; border-radius: 18px; font-size: 14px; line-height: 1.4; word-wrap: break-word; border-bottom-right-radius: 0; text-align: right; }
        ...
        #enviar { padding: 10px 14px; background: red; color: #111; border: none; cursor: pointer; }
    </style>
</head>
<body>
    <div id="janela-chat">
