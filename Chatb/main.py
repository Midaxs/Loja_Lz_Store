...
db = mysql.connector.connect(
    host="srv1660.hstgr.io",      # Geralmente o mesmo do painel ou verifique o IP
    user="u182528050_lzstore",
    password="HQGMUDwFHfOPv4f!",
    database="u182528050_lzstore"  # Provavelmente o mesmo que o user, confirme no painel
)

historico = []
atendimento_humano = False  # Controla se o atendimento humano foi chamado
